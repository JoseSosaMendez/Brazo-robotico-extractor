...
marker create  &
   ...
   adams_id = 12  &
   location = 117.6999464653, 472.0306661683, 2.7077638732E-005  &
...
marker create  &
   ...
   adams_id = 129  &
   location = 104.10845223, 294.6853546149, 5.4064739253E-004  &
   orientation = 0.0d, 0.0d, 0.0d
!
marker create  &
   marker_name = .Brazo_Final.BrazoA.cm  &
   adams_id = 14  &
   location = 100.8377893716, 341.5692476441, 5.9034613898E-004  &
   orientation = 3.0742057915d, 90.0324302538d, 359.8032954765d
!
marker create  &
...
marker create  &
   ...
   adams_id = 16  &
   location = 118.39154777, 434.6853546149, 3.6853061634E-005  &
...
marker create  &
   ...
   orientation = 9.521563505E-007d, 0.0d, 0.0d
!
marker create  &
...
marker create  &
   ...
   adams_id = 30  &
   location = 107.670410734, 279.9995759339, 220.8067373514  &
   orientation = 90.0096806107d, 176.1108227114d, 4.8239090875E-003d
!
marker create  &
...
marker create  &
   ...
   orientation = 89.9997607646d, 175.7889769066d, 3.7021351464E-004d
!
marker create  &
...
marker create  &
   ...
   adams_id = 100  &
   location = 205.7465270863, 219.2412470662, 526.1451050487  &
   orientation = 11.4142131234d, 88.7273965904d, 8.8467364254d
!
part create rigid_body mass_properties  &
   part_name = .Brazo_Final.Hombro  &
   density = 1.0E-006
...
marker create  &
   ...
   adams_id = 104  &
   location = 126.7001638857, 72.4549104778, 183.8536905645  &
   orientation = 352.7364397409d, 178.0237730892d, 266.8448574182d
!
marker create  &
...
marker create  &
   ...
   adams_id = 106  &
   location = 126.3637561168, 66.7826840206, 21.2349042853  &
   orientation = 84.4245427358d, 124.789576917d, 357.6371173459d
!
marker create  &
...
!
file parasolid read  &
   file_name = "Articulacion_3_plant.xmt_txt"  &
   model_name = .Brazo_Final
!
geometry attributes  &
...
simulation script create  &
   ...
   commands =   &
              "simulation single_run transient type=auto_select initial_static=no end_time=5.0 step_size=1.0E-002 model_name=.Brazo_Final"
!
